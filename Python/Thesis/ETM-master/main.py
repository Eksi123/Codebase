...
parser.add_argument('--data_path', type=str, default='Thesis/ETM-master/min_df10', help='directory containing data')
...
if args.mode == 'train':
    ...
    for epoch in range(0, args.epochs):
        ...
        model.train_for_epoch(epoch, args, train_tokens)
        val_ppl = model.evaluate(args, 'val', train, vocab,  test1, test2)
