...
class DocDataset(Dataset):
    def __init__(self,taskname,txtPath=None,lang="zh",tokenizer=None,stopwords=None,no_below=5,no_above=0.1,hasLable=False,rebuild=False,use_tfidf=False):
        ...
        if not rebuild and os.path.exists(os.path.join(tmpDir,'corpus.mm')):
            ...
            print(self.txtLines[-1],self.docs[-1])
            ...
            self.bows, _docs = [],[]
            print(self.dictionary.doc2bow(self.docs[0]))
...
if __name__ == '__main__':
    ...
    # for word  in docSet.docs[0]:
    #     print(docSet.dictionary.token2id[word])
    # print(docSet.__getitem__(0)[1][:30])
    # print('docSet.docs[10]:',docSet.docs[10])
    # print('docSet.docs[10]:',len(docSet.docs))
    # print(type(next(iter(dataloader))[1]), next(iter(dataloader))[1].shape)
